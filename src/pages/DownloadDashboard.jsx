          ...
          switch (selectedTopList) {
            ...
            case 'bookmarks': 
              ...
              return (
                <tr className='table--th1'>
                  <th>Name</th>
                  <th>Percentage of User Preference</th>
                </tr>
              );
            default:
              return null;
          ...
          <div className="share--details-container" ref={dashboardRef}>
            ...
            <div className="share--dashboard-header">
              ...
              {topLocationItinerary.length > 0 ? (
                <p>
                  The information displayed below is {selectedTopList}.
                </p>
              ) : (
              ...
              <div className="mt-20px">
                ...
                <table className='border--table'>
                  ...
                  {selectedTopList === 'userpreference' && userPreference && (
                    Object.entries(userPreference.preference_percentages).map(([preference, percentage], index) => (
                      <tr key={index} className="top-spot-item">
                        <td>{preference}</td>
